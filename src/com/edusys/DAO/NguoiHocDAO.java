...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String> {
    ...
    public void insert(NguoiHoc model) {
        insert_sql = "INSERT INTO NguoiHoc (MaNH, HoTen, NgaySinh, GioiTinh, DienThoai, Email, GhiChu, MaNV, ngayDK) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void update(NguoiHoc model) {
        update_sql = "UPDATE NguoiHoc SET HoTen=?, NgaySinh=?, GioiTinh=?, DienThoai=?, Email=?, GhiChu=?,MaNV =  ? WHERE  MaNH =  ?";
    ...
    public void delete(String id) {
        delete_sql = "DELETE FROM NguoiHoc WHERE MaNH=?";
        JdbcHelper.executeUpdate(delete_sql, id);
    }

    @Override
    public NguoiHoc selectById(String id) {
        selectById_sql = "SELECT * FROM NguoiHoc WHERE MaNH=?";
    ...
    public List<NguoiHoc> selectAll() {
        selectAll_sql = "SELECT * FROM NguoiHoc";
